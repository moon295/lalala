<?php
/**
 *  Admin/Customer/Site/Delete/Complete.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
...
/**
 *  admin_customer_site_delete_completeフォームの実装
 *
 *  @author    Alev Co., Ltd.
 *  @access    public
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerSiteDeleteComplete extends Lpo_ActionForm
{
...
/**
 *  admin_customer_site_delete_completeアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @access     public
 *  @package    Lpo
 */
class Lpo_Action_AdminCustomerSiteDeleteComplete extends Lpo_ActionClass
{
    /**
     *  @access private
     *  @var    array  セッション格納領域
    ...
    /**
     *  admin_customer_site_delete_completeアクションの前処理
     *
     *  @access    public
