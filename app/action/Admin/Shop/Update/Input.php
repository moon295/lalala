<?php
/**
 *  Admin/Customer/Update/Input.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
...
/**
 *  admin_customer_update_inputフォームの実装
 *
 *  @author    Alev Co., Ltd.
 *  @access    public
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerUpdateInput extends Lpo_ActionForm
{
     ...
     */
     var $form = array(
        'action_admin_customer_update_input' => array(
            'type'          => VAR_TYPE_INT,
            'name'          => 'ID',
            'required'      => true,
...
/**
 *  admin_customer_update_inputアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @access     public
 *  @package    Lpo
 */
class Lpo_Action_AdminCustomerUpdateInput extends Lpo_ActionClass
{
    /**
     *  @access private
     *  @var    array  セッション格納領域
    ...
    /**
     *  admin_customer_update_inputアクションの前処理
     *
     *  @access    public
    ...
    {
        if (!$this->_session) {
            $search = array('id' => $this->af->get('action_admin_customer_update_input'));
            // 管理者ID
