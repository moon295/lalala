<?php
/**
 *  Admin/Customer/Insert/Confirm.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
...
/**
 *  admin_customer_insert_confirmフォームの実装
 *
 *  @author    Alev Co., Ltd.
 *  @access    public
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerInsertConfirm extends Lpo_Form_AdminCustomerActionForm
{
}

/**
 *  admin_customer_insert_confirmアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @access     public
 *  @package    Lpo
 */
class Lpo_Action_AdminCustomerInsertConfirm extends Lpo_ActionClass
{
    /**
     *  @access private
     *  @var    array  セッション格納領域
    ...
    /**
     *  admin_customer_insert_confirmアクションの前処理
     *
     *  @access    public
    ...
    function perform()
    {
        ...
        $this->af->setAppNE('tpl_file', 'admin_customer_insert_confirm');
        return 'admin_customer_default';
    }
}
?>
