<?php
/**
 *  Admin/Customer/Site/Update/Confirm.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
...
/**
 *  admin_customer_site_update_confirmフォームの実装
 *
 *  @author    Alev Co., Ltd.
 *  @access    public
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerSiteUpdateConfirm extends Lpo_Form_AdminCustomerSiteActionForm
{
}

/**
 *  admin_customer_site_update_confirmアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @access     public
 *  @package    Lpo
 */
class Lpo_Action_AdminCustomerSiteUpdateConfirm extends Lpo_ActionClass
{
    /**
     *  @access private
     *  @var    array  セッション格納領域
    ...
    /**
     *  admin_customer_site_update_confirmアクションの前処理
     *
     *  @access    public
    ...
    function perform()
    {
        ...
        $this->af->setAppNE('tpl_file', 'admin_customer_site_update_confirm');
        return 'admin_customer_site_default';
    }
}
?>
