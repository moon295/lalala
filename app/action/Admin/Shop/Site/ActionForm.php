<?php
/**
 *  Admin/Customer/Site/ActionForm.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
...
/**
 *  admin_customer_siteフォームの実装
 *
 *  @author    Alev Co., Ltd.
 *  @access    public
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerSiteActionForm extends Lpo_ActionForm
{
    ...
    function validate()
    {
        if (strstr($this->backend->ac->actionName, '_insert_')) {
            $this->form['tel_count']['required'] = true;
        }
        $url = $this->get('url');
