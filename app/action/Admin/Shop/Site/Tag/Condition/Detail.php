<?php
/**
 *  Admin/Customer/Site/Tag/Condition/Detail.php
 *
 *  @author    Alev Co., Ltd.
 *  @package   Lpo
 ...
 *  @package   Lpo
 */
class Lpo_Form_AdminCustomerSiteTagConditionDetail extends Lpo_ActionForm
{
     ...
     */
     var $form = array(
        'action_admin_customer_site_tag_condition_detail' => array(
            'type'          => VAR_TYPE_INT,
            'name'          => 'ID',
            'required'      => true,
...
/**
 *  action_admin_customer_site_tag_condition_detailアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @access     public
 *  @package    Lpo
 */
class Lpo_Action_AdminCustomerSiteTagConditionDetail extends Lpo_ActionClass
{
    /**
     *  @access private
     *  @var    array  セッション格納領域
    ...
    /**
     *  action_admin_customer_site_tag_condition_detailアクションの前処理
     *
     *  @access    public
    ...
    function perform()
    {
        $search = array('id' => $this->af->get('action_admin_customer_site_tag_condition_detail'));
        // 管理者ID
        ...
        $this->af->setAppNE('tpl_file', 'admin_customer_site_tag_condition_detail');
