...
/**
 *  admin_customer_site_tel_listフォームの実装
 *
 *  @author     Alev Co., Ltd.
 *  @package    Lpo
 *  @access     public
 */
class Lpo_Form_AdminCustomerSiteTelList extends Lpo_ActionForm
{
     ...
     */
    var $form = array(
        'action_admin_customer_site_tel_list' => array(
            'type'          => VAR_TYPE_INT,
            'name'          => 'ID',
...
/**
 *  admin_customer_site_tel_listアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @package    Lpo
 *  @access     public
 */
class Lpo_Action_AdminCustomerSiteTelList extends Lpo_ActionClass
{
    /**
     *  admin_customer_site_tel_listアクションの前処理
     *
     *  @access public
    ...
    function perform()
    {
        ...
        // 選択したサイト情報取得・設定
        $search = array('id' => $search['action_admin_customer_site_tel_list']);
        // 管理者ID
