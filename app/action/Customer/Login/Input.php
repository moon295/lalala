...
/**
 *  customer_login_inputフォームの実装
 *
 *  @author     Alev Co., Ltd.
 *  @package    Lpo
 *  @access     public
 */
class Lpo_Form_CustomerLoginInput extends Lpo_ActionForm
{
...
/**
 *  customer_login_inputアクションの実装
 *
 *  @author     Alev Co., Ltd.
 *  @package    Lpo
 *  @access     public
 */
class Lpo_Action_CustomerLoginInput extends Lpo_ActionClass
{
    /**
     * @access protected
