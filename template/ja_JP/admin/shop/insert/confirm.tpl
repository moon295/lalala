{include file="admin/header.tpl" title="顧客新規登録確認｜顧客管理"}
      <div class="main-container-inner">
{include file="admin/sidebar.tpl"}
        <div class="main-content">
{include file="admin/breadcrumb.tpl" step="icon-user:`$config.url`admin/?action_admin_customer_list=true:顧客管理|::顧客新規登録確認"}
...
{* PAGE CONTENT BEGINS *}
                <form method="post" class="form-horizontal" role="form">
                  ...
                  <div class="form-actions">
                    {csrfid}
                    {uniqid}
                    <button type="submit" name="action_admin_customer_insert_input" value="true" class="btn"><i class="icon-long-arrow-left"></i> 戻る</button>
                    <button type="submit" name="action_admin_customer_insert_complete" value="true" class="btn btn-primary pull-right"><i class="icon-pencil"></i> 登録</button>
                  </div>
                </form>
{* PAGE CONTENT ENDS *}
              </div>{* /.col *}
