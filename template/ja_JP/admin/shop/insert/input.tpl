{include file="admin/header.tpl" title="顧客新規登録｜顧客管理"}
      <div class="main-container-inner">
{include file="admin/sidebar.tpl"}
        <div class="main-content">
{include file="admin/breadcrumb.tpl" step="icon-user:`$config.url`admin/?action_admin_customer_list=true:顧客管理|::顧客新規登録入力"}
...
{* PAGE CONTENT BEGINS *}
                <form method="post" class="form-horizontal" role="form">
                  ...
                  <div class="form-actions">
                    ...
                    <button type="submit" name="action_admin_customer_insert_confirm" value="true" class="btn btn-primary pull-right"><i class="icon-desktop"></i> 確認する</button>
