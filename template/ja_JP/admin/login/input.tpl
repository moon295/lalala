                        ...
                        <fieldset>
                          <label class="block clearfix">
                            <span class="block input-icon input-icon-right">
                              <input type="text" class="form-control" placeholder="アカウント" name="account" value="{$form.account}">
                              <i class="icon-user"></i>
                            </span>
                          </label>
                          {msg name="account" type="full" offset=0}
                          <label class="block clearfix">
                            <span class="block input-icon input-icon-right">
                          ...
                          <div class="clearfix">
                            {csrfid}
                            <button type="submit" name="action_admin_login_complete" class="width-35 pull-right btn btn-sm btn-primary" value="true">
                              <i class="icon-key"></i>
                              ログイン
                            </button>
                          </div>
