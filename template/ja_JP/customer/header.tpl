    ...
    <div class="navbar navbar-default" id="navbar" style="background:#24a2dd;">
      ...
      <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
          <a href="{$config.url}customer/" class="navbar-brand">
            <img src="{$config.url}assets/img/logo.png" alt="TELシル" height="26">
          </a>{* /.brand *}
        </div>{* /.navbar-header *}
            ...
            <li class="light-blue">
              <a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background:#1492cd;">
                ...
                <span class="user-info">
                  <small>ようこそ</small>
                  {$smarty.session.customer.login.company_name|escape}様
                </span>
              ...
              <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                <li>
                  <a href="{$config.url}customer/logout/">
                    <i class="icon-off"></i>
                    ログアウト
                  </a>
                </li>
